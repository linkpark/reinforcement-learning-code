...
def make_copy_params_op(v1_list, v2_list):
    """
    Creates an operation that copies parameters from variable in v1_list to variable in v2_list
...
def make_train_op(local_estimator, global_estimator):
    ...
    """
    local_grads, _ = zip(*local_estimator.grads_and_var)
    # Clip gradients
...
class Worker(object):
    ...
    def __init__(self, name, env, policy_net, value_net, global_counter, discount_factor=0.99, summary_writer=None, max_global_steps=None):
        ...
        :param policy_net: Instance of the globally shared policy net
        :param value_net: Instance of the globally shared value net
        :param global_counter: Iterator that holds the global step
        ...
        self.global_stpe = tf.train.global_step()
        ...
        self.copy_params_op = make_copy_params_op(
            ...
            tf.contrib.slim.get_variables(scope=self.name+'/', collections=tf.GraphKeys.TRAINABLE_VARIABLES))
    ...
    def update(self, transitions, sess):
        ...
        :param transitions:
        :param sess:
        :return: loss and summaries of each network
        """
