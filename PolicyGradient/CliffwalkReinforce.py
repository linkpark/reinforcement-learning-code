...
from lib.env.cliff_walking import CliffWalkingEnv
...
class PolicyEstimator():
    ...
    def __init__(self, learning_rate=0.01, scope="policy_estimator"):
        with tf.variable_scope(scope):
            ...
            # this is important, the loss function of REINFORCE algorithm with baseline is
            # loss = log( G_t - b(S_t) ) * pi(a,s)
...
def reinforce(env, estimator_policy, estimator_value, num_episodes, discount_factor=1.0):
    ...
    :param estimator_value: Value Function approximator, used as baseline
